# Security Considerations for constant-product-amm

This document outlines security considerations and best practices for the constant-product-amm template.
