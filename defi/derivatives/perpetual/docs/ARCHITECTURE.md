...
This document describes the architectural design of the perpetual-futures template.

## Overview

The perpetual-futures template provides a foundation for [TEMPLATE FUNCTIONALITY].
