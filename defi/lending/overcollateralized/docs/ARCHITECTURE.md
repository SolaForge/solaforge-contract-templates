# overcollateralized-lending Architecture

This document describes the architectural design of the overcollateralized-lending template.

## Overview

The overcollateralized-lending template provides a foundation for [TEMPLATE FUNCTIONALITY].
