# Security Considerations for overcollateralized-lending

This document outlines security considerations and best practices for the overcollateralized-lending template.
